...
class BusinessFlashSale extends StatefulWidget {
  final List pl;
 const BusinessFlashSale ({ Key key, this.pl }): super(key: key);
...
class BusinessFlashSaleState extends State<BusinessFlashSale> {
  ...
  Future<String> getData() async {
    ...
    productList[0]['price'];
    http.Response  result = await http.get('$path/product/categories',);   
      ...
      //       buildSlidingPanel(scrollController: scrollController),
        ...
        RefreshIndicator(
          ...
          child: Column(
            ...
            children: <Widget>[
              CategoriesList(categories: catList),
              Expanded(
                child: Container(
                      ...
                      return Dismissible(
                        ...
                        InkWell(
                          onTap: ()=> Navigator.push(context, 
                            MaterialPageRoute(builder: (context)=>ItemDetail(details: productList[index]))),
                          child: Padding(
